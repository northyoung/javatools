...
public class StringUtilsDemo {
    public static void main(String[] args) {
        ...
        stringUtilsDemo.IsEmpty(); //1.字符串的空判断
        stringUtilsDemo.TestTrim(); //2.字符串的Trim
        stringUtilsDemo.TestSplit(); //3.字符串的分割
        stringUtilsDemo.TestEscape(); //5.字符串的Escape
        stringUtilsDemo.TestStringUtilsJoin(); //4.字符串的连接
        stringUtilsDemo.TestRandomStringUtils();
        stringUtilsDemo.TestArrayUtils();
    }
    ...
    /**
     * 5.字符串的Escape  StringEscapeUtils 工具类
     */
    ...
    /**
     * 8、日期  DateUtils  DateFormatUtils
     */
